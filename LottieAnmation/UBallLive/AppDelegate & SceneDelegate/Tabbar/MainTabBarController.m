...
- (NSArray *)viewControllersForTabBar {
    UIViewController *firstNavigationController = [[CYLBaseNavigationController alloc] initWithRootViewController:ViewController_1.new];
//    [firstViewController cyl_setHideNavigationBarSeparator:YES];
    // [firstViewController cyl_setNavigationBarHidden:YES];
    UIViewController *secondNavigationController = [[CYLBaseNavigationController alloc] initWithRootViewController:ViewController_2.new];
//    [secondViewController cyl_setHideNavigationBarSeparator:YES];
    // [secondViewController cyl_setNavigationBarHidden:YES];

    UIViewController *thirdNavigationController = [[CYLBaseNavigationController alloc] initWithRootViewController:ViewController_3.new];
//    [thirdViewController cyl_setHideNavigationBarSeparator:YES];
    
    UIViewController *fourthNavigationController = [[CYLBaseNavigationController alloc] initWithRootViewController:ViewController_4.new];
...
- (NSArray *)tabBarItemsAttributesForTabBar {
    ...
    NSDictionary *firstTabBarItemsAttributes = @{
                                                 ...
                                                 CYLTabBarItemImage : KBuddleIMG(@"⚽️PicResource", @"TabbaritemImage", nil,@"home_normal"),  /* NSString and UIImage are supported*/
                                                 CYLTabBarItemSelectedImage : KBuddleIMG(@"⚽️PicResource",@"TabbaritemImage",nil,@"home_normal"),  /* NSString and UIImage are supported*/
...
//                                                 CYLTabBarLottieSize: [NSValue valueWithCGSize:CGSizeMake(22, 22)]
    ...
    NSDictionary *secondTabBarItemsAttributes = @{
                                                  ...
                                                  CYLTabBarItemImage : KBuddleIMG(@"⚽️PicResource",@"TabbaritemImage",nil,@"home_normal"),
                                                  CYLTabBarItemSelectedImage : KBuddleIMG(@"⚽️PicResource",@"TabbaritemImage",nil,@"home_normal"),
